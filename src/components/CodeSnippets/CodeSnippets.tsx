...
import TextEmplacement from '../TexteEmplacement/TextEmplacement';
...
export const CodeSnippets: React.FC<CodeSnippetsProps> = ({
  ...
  return (
    ...
    >
      <TextEmplacement
        pathTitle="code-snippet.tsx"
        fileName={'code-snippet.tsx'}
        onClick={onClose}
      >
        <div className="snippet-container">
          <div className="d-flex w-100 mb-4 justify-content-between align-items-center"></div>
          ...
          <div className="user-container">
            ...
            <div
              ...
              className="cursor-pointer hover detail-container"
            >
              <BiCommentDetail className="mx-2" size={'16px'} />
